...
RasterizerService.prototype.startService = function() {
  //console.log('Phantomjs command path is: ' + this.config.command);
//  var rasterizer = spawn(this.config.command, ['/src/scripts/rasterizer.js', this.config.path, this.config.port, this.config.viewport]);	
    var appDir = path.dirname(require.main.filename);
	var rasterizer = spawn(this.config.command, [path.join(appDir, 'scripts', 'rasterizer.js'), this.config.path, this.config.port, this.config.viewport]);
